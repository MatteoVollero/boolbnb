    ...
    <form action="{{route('search')}}" method="GET" enctype="multipart/form-data">
        ...
        <div class="jumbotron_search_item">
            ...
            <div class="search_item">
                ...
                <input type="text" class="location_input form_input" id="location" autocomplete="off" name="location" data-long="" data-lat="" required minlength="5" maxlength="100" placeholder="Insert the place please" value="{{old("location")}}">
